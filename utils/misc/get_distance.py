...
from data.locations import Center
...
def choose_shortest(location: types.Location):
    distances = list()
    for shop_name, shop_location in Center:
...
# bu funksiya hech qanday uzgarishsiz qoladi
# bu biz turgan joydan markazgacha bolgan masofani olchab beradi
